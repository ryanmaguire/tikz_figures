...
\begin{document}
    ...
    \begin{tikzpicture}[%
        ...
        % Two horizontal lines that bound the region.
        ...
        % Label that these lines represent distances in the figure.
